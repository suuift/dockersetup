...
```powershell
powershell -Command "Invoke-WebRequest -Uri 'https://github.com/suuift/dockersetup/releases/download/v1.5.1/dockersetup.exe' -OutFile 'dockersetup.exe'; .\dockersetup.exe"
```

### Linux (Shell)
Run this command in your terminal:
```bash
curl -L -o dockersetup https://github.com/suuift/dockersetup/releases/download/v1.5.1/dockersetup && chmod +x dockersetup && ./dockersetup
```
