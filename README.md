...
*   **Virtual Environment (Recommended):** Python virtual environment setup using `venv` or `poetry`.
...
Follow the interactive menus to select your installation tier, configure your credentials, and build/deploy your stack.
...
### Upgrade Templates
Run `python dockersetup.py`, select **Upgrade Templates** to safely apply updates from `templates.yml` to your existing configuration files without data loss.
